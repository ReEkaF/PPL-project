...
class PenilaianEkstraController extends Controller
{
    public function index()
    {
        ...
        try {
            ...
            $anggota = RegistrasiEkstrakurikuler::with('siswa')->where('status', 'diterima')->where('id_ekstrakurikuler', $id_ekstra)->get();
            $anggota_aktif = [];
            ...
            return view('pembina_ekstra.penilaian.index', ['laporan_anggota' => [], 'nama_ekstra' => 'Tidak Ada Ekstrakurikuler', 'penilaian' => [], 'tahun_ajaran_aktif' => $tahun_ajaran_aktif, 'id_ekstra' => null, 'tahun_ajaran' => $tahun_ajaran]);
        }
    }
    ...
    public function show($id)
    {
        ...
        try {
            ...
            return view('pembina_ekstra.penilaian.index', ['laporan_anggota' => [], 'nama_ekstra' => 'Belum Ada Ekstrakurikuler', 'penilaian' => [], 'tahun_ajaran_aktif' => $tahun_ajaran_aktif, 'id_ekstra' => null, 'tahun_ajaran' => $tahun_ajaran]);
        }
    }
    ...
    public function storeOrUpdate(Request $request, $id_siswa)
    {
        ...
        $nilai = strtoupper($request->penilaian);
        ...
        $fresh = PenilaianEkstrakurikuler::where('id_siswa', $id_siswa)->where('id_tahun_ajaran', $tahun_ajaran)->first();
        $tgl_penilaian = $fresh && $fresh->tgl_penilaian ? \Carbon\Carbon::parse($fresh->tgl_penilaian)->translatedFormat('d M Y, H:i') : now()->translatedFormat('d M Y, H:i');
