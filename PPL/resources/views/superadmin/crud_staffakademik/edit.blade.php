<x-admin-layout>
    <div class="p-6 max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit Akun Staff Akademik</h1>
            <p class="text-sm text-slate-500 mt-1">Perbarui data profil staff akademik yang bersangkutan</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 sm:p-8">
            <form action="{{ route('superadmin.kelola_staff_akademik.update') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="username" name="username" value="{{ old('username', $staffakademik->username) }}"
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $staffakademik->email) }}"
                            class="w-full text-sm rounded-lg border border-slate-300 px-3.5 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#06466C]/20 focus:border-[#06466C] transition-colors"
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_staff_akademik" name="nama_staff_akademik" value="{{ old('nama_staff_akademik', $staffakademik->nama_staff_akademik) }}"
                            class="w-full text-sm rounded-lg border border-slate-300 px-3.5 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#06466C]/20 focus:border-[#06466C] transition-colors"
                    ...
                    <div>
                        ...
                        <input type="text" id="wa_staff_akademik" name="wa_staff_akademik" value="{{ old('wa_staff_akademik', $staffakademik->wa_staff_akademik) }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="alamat_staff_akademik" name="alamat_staff_akademik" rows="3"
                            class="w-full text-sm rounded-lg border border-slate-300 px-3.5 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#06466C]/20 focus:border-[#06466C] transition-colors"
                            placeholder="Alamat domisili staf">{{ old('alamat_staff_akademik', $staffakademik->alamat_staff_akademik) }}</textarea>
