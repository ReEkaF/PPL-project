    ...
    <div class="px-4 lg:px-6">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-3">
                ...
                {{-- Logo --}}
                <a href="{{ route('superadmin.dashboard') }}" class="flex items-center gap-2.5 group focus:outline-none">
                    ...
                    <div class="hidden sm:flex flex-col">
                        ...
                        <span class="text-[10px] font-medium text-slate-400 tracking-wider uppercase">Superadmin</span>
                    </div>
                </a>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="hidden lg:flex flex-col items-end">
                    <span class="text-sm font-semibold text-slate-700">{{auth()->guard('web-superadmin')->user()->username}}</span>
                    <span class="text-xs text-slate-400">Superadmin</span>
                </div>
                ...
                <div class="relative flex items-center" x-data="{ open: false }">
                    <button @click="open = !open" type="button"
                        ...
                        aria-expanded="false">
                        {{ strtoupper(substr(auth()->guard('web-superadmin')->user()->username, 0, 2)) }}
                    </button>
                    ...
                    <div x-show="open" @click.away="open = false" x-cloak
                        ...
                        <div class="px-4 py-3 border-b border-slate-100">
                            <p class="text-sm font-semibold text-slate-800">{{auth()->guard('web-superadmin')->user()->username}}</p>
                            <p class="text-xs text-slate-500 truncate">{{auth()->guard('web-superadmin')->user()->email}}</p>
                        </div>
                        <ul class="py-1">
                            <li>
