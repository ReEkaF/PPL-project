        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-slate-100">
                ...
                <ul class="pb-2 space-y-1">
                    ...
                    <li>
                        <x-sidebar-link href="{{ route('lihat-jadwal-siswa') }}" :active="request()->is('siswa/dashboard/jadwal-pelajaran*') || request()->is('siswa/dashboard/lihat-jadwal*') || request()->is('dashboard/lihat-jadwal*')">
                            <x-sidebar-icon>
