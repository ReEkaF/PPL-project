            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('beranda.home') }}" class="flex items-center gap-2.5 group focus:outline-none">
                    ...
                    <div class="hidden sm:flex flex-col">
                        ...
                        <span class="text-[10px] font-medium text-slate-400 tracking-wider uppercase">Staff Akademik</span>
                    </div>
                </a>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative flex items-center" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-cloak
                        ...
                        <ul class="py-1">
                            <li>
                                <a href="{{ route('staff_akademik.profile') }}"
