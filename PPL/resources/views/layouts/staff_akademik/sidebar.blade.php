        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-slate-100">
                ...
                <ul class="pb-2 space-y-1">
                    ...
                    {{-- Data Master --}}
                    <li>
                        <x-sidebar-dropdown label="Master Data" id="master" :active="request()->is('staff_akademik/kelas*') || request()->is('staff_akademik/daftar-kelas*') || request()->is('staff_akademik/daftarkelas*') || request()->is('staff_akademik/guru-mata-pelajaran*') || request()->is('staff_akademik/mata-pelajaran*') || request()->is('staff_akademik/jadwal*') || request()->is('staff_akademik/tahun-ajaran*')">
                            <x-sidebar-icon>
                                <path fill-rule="evenodd" d="M4 4a1 1 0 0 1 1-1h14a1 1 0 1 1 0 2v14a1 1 0 1 1 0 2H5a1 1 0 1 1 0-2V5a1 1 0 0 1-1-1Zm5 2a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H9Zm5 0a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-1Zm-5 4a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1H9Zm5 0a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1h-1Zm-3 4a2 2 0 0 0-2 2v3h2v-3h2v3h2v-3a2 2 0 0 0-2-2h-2Z" clip-rule="evenodd" />
                            </x-sidebar-icon>
                        </x-sidebar-dropdown>
                        <x-sidebar-dropdown-list id="master" :active="request()->is('staff_akademik/kelas*') || request()->is('staff_akademik/daftar-kelas*') || request()->is('staff_akademik/daftarkelas*') || request()->is('staff_akademik/guru-mata-pelajaran*') || request()->is('staff_akademik/mata-pelajaran*') || request()->is('staff_akademik/jadwal*') || request()->is('staff_akademik/tahun-ajaran*')">
                    <li>
                        <x-sidebar-dropdown-list-link href="{{route('staff_akademik.tahun-ajaran.index')}}" :active="request()->is('staff_akademik/tahun-ajaran*')">Tahun Ajaran</x-sidebar-dropdown-list-link>
                    </li>
                    <li>
